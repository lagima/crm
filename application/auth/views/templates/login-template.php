...
<html>
	<head>
		...
		<!-- iCheck -->
		<link rel="stylesheet" href="<?= $this->asset('/assets/vendors/mercury/framework/plugins/iCheck/square/blue.css') ?>">
	...
	<body class="hold-transition login-page">
		...
		<!-- iCheck -->
		<script src="<?= $this->asset('assets/vendors/mercury/framework/plugins/iCheck/icheck.min.js') ?>"></script>
		<!-- Custom js -->
		<script src="<?= $this->asset('assets/js/login.js') ?>"></script>
